...
Pipeline figure removed from the repository to keep the checkout small.
...
|logP|SA|
|----|--|
|logP figure removed from repo|SA figure removed from repo|
|weight|QED|
|weight figure removed from repo|QED figure removed from repo|
